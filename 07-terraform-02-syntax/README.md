...
```
   vagrant@vagrant:~/cloud-terraform$ terraform plan
...
Terraform will perform the following actions:
  ...
  # yandex_iam_service_account.roman will be created
...
Changes to Outputs:
  ...
  + yc_account_ID            = (known after apply)
  + yc_subnet                = "subnet1"
  + yc_zone                  = (known after apply)
```
   
</details>

1. Мы можем создать образ при помощи инструмента Packer. 
2. Вот ссылка на репозиторий: https://github.com/RamiresHab/cloud-terraform
